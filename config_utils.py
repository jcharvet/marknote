...
CONFIG_KEY_AUTOSAVE_ENABLED = "autosave_enabled"
CONFIG_KEY_AUTOSAVE_INTERVAL = "autosave_interval"
...
DEFAULT_CONFIG = {
    ...
    CONFIG_KEY_AUTOSAVE_ENABLED: True,
    CONFIG_KEY_AUTOSAVE_INTERVAL: 60
}
